...
Matlab tools for loading, interpolating, and displaying BedMachine ice sheet topography. (Also check out the equivalent [Bedmap3 tools](https://github.com/chadagreene/bedmap3).)
...
* BedMachine data for [Greenland](https://nsidc.org/data/IDBMG4) or [Antarctica](https://nsidc.org/data/nsidc-0756/versions/4) (Morlighem et al., 2017 & 2019).
